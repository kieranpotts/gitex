"""
Test suite for git-default command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-default script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-default"

    assert script_path.exists(), f"git-default script not found at {script_path}"

    return str(script_path)


class TestGitDefault:
    """Test cases for git-default command"""
