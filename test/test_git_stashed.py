"""
Test suite for git-stashed command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-stashed script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-stashed"

    assert script_path.exists(), f"git-stashed script not found at {script_path}"
