"""
Test suite for git-backup command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-backup script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-backup"

    assert script_path.exists(), f"git-backup script not found at {script_path}"

    return str(script_path)


class TestGitBackup:
    """Test cases for git-backup command"""
