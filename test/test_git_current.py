"""
Test suite for git-current command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-current script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-current"

    assert script_path.exists(), f"git-current script not found at {script_path}"

    return str(script_path)


class TestGitCurrent:
    """Test cases for git-current command"""
