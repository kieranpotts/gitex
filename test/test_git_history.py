"""
Test suite for git-history command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-history script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-history"

    assert script_path.exists(), f"git-history script not found at {script_path}"

    return str(script_path)


class TestGitHistory:
    """Test cases for git-history command"""
