"""
Test suite for git-changes command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-changes script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-changes"

    assert script_path.exists(), f"git-changes script not found at {script_path}"

    return str(script_path)


class TestGitChanges:
    """Test cases for git-changes command"""
