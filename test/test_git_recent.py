"""
Test suite for git-recent command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-recent script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-recent"

    assert script_path.exists(), f"git-recent script not found at {script_path}"

    return str(script_path)


class TestGitRecent:
    """Test cases for git-recent command"""
