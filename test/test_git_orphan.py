"""
Test suite for git-orphan command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-orphan script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-orphan"

    assert script_path.exists(), f"git-orphan script not found at {script_path}"

    return str(script_path)


class TestGitOrphan:
    """Test cases for git-orphan command"""
