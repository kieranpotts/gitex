...
class TestGitex:
    ...
    def test_no_arguments_shows_help(self, test_repo, script_path):
    ...
    def test_help_flag_short(self, test_repo, script_path):
        """Test the -h flag shows help."""

        result = test_repo.run(script_path, "-h")
    ...
    def test_help_flag_long(self, test_repo, script_path):
    ...
    def test_version_flag_short(self, test_repo, script_path):
        """Test the -v flag shows version."""

        result = test_repo.run(script_path, "-v")
    ...
    def test_version_flag_long(self, test_repo, script_path):
        """Test the --version flag shows version."""

        result = test_repo.run(script_path, "--version")
    ...
    def test_commands_flag_short(self, test_repo, script_path):
        """Test the -c flag lists commands."""

        result = test_repo.run(script_path, "-c")
    ...
    def test_commands_flag_long(self, test_repo, script_path):
        """Test the --commands flag lists commands."""

        result = test_repo.run(script_path, "--commands")
    ...
    def test_version_output_format(self, test_repo, script_path):
    ...
    def test_help_contains_examples(self, test_repo, script_path):
    ...
    def test_unknown_option(self, test_repo, script_path):
    ...
    def test_too_many_arguments(self, test_repo, script_path):
        """Test that multiple arguments return an error."""

        result = test_repo.run(script_path, "--version", "--commands")
