"""
Test suite for git-down command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-down script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-down"

    assert script_path.exists(), f"git-down script not found at {script_path}"

    return str(script_path)


class TestGitDown:
    """Test cases for git-down command"""
