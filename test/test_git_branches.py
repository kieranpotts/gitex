"""
Test suite for git-branches command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-branches script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-branches"

    assert script_path.exists(), f"git-branches script not found at {script_path}"

    return str(script_path)


class TestGitBranches:
    """Test cases for git-branches command"""
