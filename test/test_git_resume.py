"""
Test suite for git-resume command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-resume script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-resume"

    assert script_path.exists(), f"git-resume script not found at {script_path}"

    return str(script_path)


class TestGitResume:
    """Test cases for git-resume command"""
