"""
Test suite for git-working command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-working script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-working"

    assert script_path.exists(), f"git-working script not found at {script_path}"

    return str(script_path)


class TestGitWorking:
    """Test cases for git-working command"""
