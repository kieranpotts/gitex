"""
Test suite for git-tracking command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-tracking script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-tracking"

    assert script_path.exists(), f"git-tracking script not found at {script_path}"

    return str(script_path)


class TestGitTracking:
    """Test cases for git-tracking command"""
