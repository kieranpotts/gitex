...
@pytest.fixture
def test_script():
    """Get the path to the git-cm script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-cm"

    assert script_path.exists(), f"git-cm script not found at {script_path}"

    return str(script_path)


class TestGitCm:
    """Test cases for git-cm command"""
