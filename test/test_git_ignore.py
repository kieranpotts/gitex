"""
Test suite for git-ignore command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-ignore script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-ignore"

    assert script_path.exists(), f"git-ignore script not found at {script_path}"

    return str(script_path)


class TestGitIgnore:
    """Test cases for git-ignore command"""
