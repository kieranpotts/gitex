...
@pytest.fixture
def test_script():
    """Get the path to the git-up script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-up"

    assert script_path.exists(), f"git-up script not found at {script_path}"

    return str(script_path)


class TestGitUp:
    """Test cases for git-up command"""
