"""
Test suite for git-track command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-track script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-track"

    assert script_path.exists(), f"git-track script not found at {script_path}"

    return str(script_path)


class TestGitTrack:
    """Test cases for git-track command"""
