"""
Test suite for git-pick command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-pick script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-pick"

    assert script_path.exists(), f"git-pick script not found at {script_path}"

    return str(script_path)


class TestGitPick:
    """Test cases for git-pick command"""
