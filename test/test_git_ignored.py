"""
Test suite for git-ignored command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-ignored script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-ignored"

    assert script_path.exists(), f"git-ignored script not found at {script_path}"

    return str(script_path)


class TestGitIgnored:
    """Test cases for git-ignored command"""
