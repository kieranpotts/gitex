"""
Test suite for git-discard command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-discard script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-discard"

    assert script_path.exists(), f"git-discard script not found at {script_path}"

    return str(script_path)


class TestGitDiscard:
    """Test cases for git-discard command"""
