"""
Test suite for git-feature command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-feature script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-feature"

    assert script_path.exists(), f"git-feature script not found at {script_path}"

    return str(script_path)


class TestGitFeature:
    """Test cases for git-feature command"""
