"""
Test suite for git-wip command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-wip script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-wip"

    assert script_path.exists(), f"git-wip script not found at {script_path}"

    return str(script_path)


class TestGitWip:
    """Test cases for git-wip command"""
