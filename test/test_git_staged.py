"""
Test suite for git-staged command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-staged script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-staged"

    assert script_path.exists(), f"git-staged script not found at {script_path}"

    return str(script_path)


class TestGitStaged:
    """Test cases for git-staged command"""
