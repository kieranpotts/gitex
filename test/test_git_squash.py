"""
Test suite for git-squash command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-squash script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-squash"

    assert script_path.exists(), f"git-squash script not found at {script_path}"

    return str(script_path)


class TestGitSquash:
    """Test cases for git-squash command"""
