...
@pytest.fixture
def test_script():
    """Get the path to the git-ff script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-ff"

    assert script_path.exists(), f"git-ff script not found at {script_path}"

    return str(script_path)


class TestGitFf:
    """Test cases for git-ff command"""
