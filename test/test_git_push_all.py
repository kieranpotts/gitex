"""
Test suite for git-push-all command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-push-all script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-push-all"

    assert script_path.exists(), f"git-push-all script not found at {script_path}"

    return str(script_path)


class TestGitPushAll:
    """Test cases for git-push-all command"""
