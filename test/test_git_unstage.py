"""
Test suite for git-unstage command.
"""
...
@pytest.fixture
def test_script():
    """Get the path to the git-unstage script"""

    repo_dir = Path(__file__).parent.parent
    script_path = repo_dir / "bin" / "git-unstage"

    assert script_path.exists(), f"git-unstage script not found at {script_path}"

    return str(script_path)


class TestGitUnstage:
    """Test cases for git-unstage command"""
