...
The commit message is not changed, only the contents of the commit. To amend the previous commit message you can use link:./git-reword.adoc[`git reword`].
...
* link:./git-unamend.adoc[`git unamend`] — Undo the last amend operation.
